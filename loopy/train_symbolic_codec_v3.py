...
def parse_args(argv: list[str] | None = None) -> SymbolicCodecConfig:
    parser = argparse.ArgumentParser(description="Train Loopy v3 symbolic codebook codec.")
    parser.add_argument("--data-path", default="loopy/example_corpus.txt")
    parser.add_argument("--output-dir", default="loopy/runs/v3_codec")
...
def create_dataloaders(config: SymbolicCodecConfig) -> tuple[DataLoader, DataLoader]:
